...
\begin{tikzpicture}
	...
	\node[rectangle, draw, right=1em of s1] (s2) {\begin{tikzpicture} \begin{axis}[
			samples=1000, domain=-2.6:2.6,
				...
				\addplot expression [no markers, smooth, thick, black] {max(0, min(1, x*0.6 + 0.5))};
			\end{axis}\end{tikzpicture}};
	\node[rectangle, draw, right=1em of s2] (t1) {\begin{tikzpicture} \begin{axis}[
			samples=1000, domain=-2.6:2.6,
				hide axis,
				xtick=\empty,
				ytick=\empty,
			...
			\end{axis}\end{tikzpicture}};
	\node[rectangle, draw, right=1em of t1] (s3) {\begin{tikzpicture} \begin{axis}[
			samples=1000, domain=-2.6:2.6,
				hide axis,
				xtick=\empty,
				ytick=\empty,
	...
	\node[rounded rectangle, draw, above=1em of m3, inner sep=0.2em] (tt) {\begin{tikzpicture} \begin{axis}[
			samples=1000, domain=-2.6:2.6,
				hide axis,
				xtick=\empty,
				ytick=\empty,
